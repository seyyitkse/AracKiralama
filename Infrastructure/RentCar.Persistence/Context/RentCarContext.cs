...
namespace RentCar.Persistence.Context
{
    public class RentCarContext : DbContext
    {
        ...
        {
            //optionsBuilder.UseSqlServer("Server=BEYZA\\SQLEXPRESS;initial Catalog=DbBitirme;integrated Security=true;TrustServerCertificate=true;MultipleActiveResultSets=true;");
